...
public class GFG {
    ...
    static void Next_Fit(int block_size[], int m, int process_size[], int n) {
        ...
        // Find a suitable block for each process as per its size and assign memory to
        // it
        ...
        for (int i = 0; i < n; i++) {
            ...
            while (j < m) {
                ...
                // mod m will traverse the blocks from the starting when the pointer reaches at
                // the end.
